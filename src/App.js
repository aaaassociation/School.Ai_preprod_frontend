          ...
          <div className="font-gilroy font-medium text-gray text-lg leading-[27px]">
            <Routes>
              ...
              <Route element={<DefaultLayout />}>
                ...
                <Route path="/schoolai/finalview" element={<PrivateRoute element={<FinalViewPage prompt={prompt} chapters={chapters} content={content} setContent={setContent} collectionId={collectionId} setCollectionId={setCollectionId} />} />} />
                ...
                <Route path="/schoolai/viewhistorycourse/:id" element={<PrivateRoute element={<ViewHistoryCoursePage />} />} />
